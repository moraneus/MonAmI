...
_lr_productions = [
  ...
  ('formula -> formula AND formula','formula',3,'p_formula_1','frontend.py',106),
  ('formula -> formula OR formula','formula',3,'p_formula_2','frontend.py',111),
  ('formula -> formula IMPLIES formula','formula',3,'p_formula_3','frontend.py',116),
  ('formula -> NOT formula','formula',2,'p_formula_4','frontend.py',120),
  ('formula -> NAME BEFORE NAME','formula',3,'p_formula_5','frontend.py',125),
  ('formula -> NAME OVERLAPS NAME','formula',3,'p_formula_6','frontend.py',130),
  ('formula -> NAME INCLUDES NAME','formula',3,'p_formula_7','frontend.py',135),
  ('formula -> NAME LPAREN data RPAREN','formula',4,'p_formula_8','frontend.py',139),
  ('formula -> SAME LPAREN NAME COMMA NAME RPAREN','formula',6,'p_formula_9','frontend.py',144),
  ('formula -> EXIST names DOT formula','formula',4,'p_formula_10','frontend.py',149),
  ('formula -> LPAREN formula RPAREN','formula',3,'p_formula_11','frontend.py',154),
  ('data -> NUMBER','data',1,'p_data_1','frontend.py',159),
  ('data -> STRING','data',1,'p_data_2','frontend.py',164),
  ('names -> NAME','names',1,'p_names_1','frontend.py',169),
  ('names -> names COMMA NAME','names',3,'p_names_2','frontend.py',174),
]
