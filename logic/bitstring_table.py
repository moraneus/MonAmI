...
class BitstringTable:
    def __init__(self, i_bit_string_length=3, i_number_of_growth=2):
        self.__m_bitstring_table = {}
        self._m_bit_string_length = i_bit_string_length
        self.__m_number_of_growth = i_number_of_growth
        self.__max_items_allowed = 2**i_bit_string_length - 1
    ...
    def lookup(self, i_event_type: str, i_key)->str:
        ...
        if i_key not in self.__m_bitstring_table.keys():
            self.__m_bitstring_table[i_key] = np.binary_repr(len(self.__m_bitstring_table.keys()),
                                                             width=self._m_bit_string_length)
    ...
    def __length_update(self, i_new_length: int):
        ...
        prefix = '0' * (i_new_length - self._m_bit_string_length)
        self._m_bit_string_length = i_new_length
    ...
    def __max_items_allowed_update(self):
        ...
        """
        self.__max_items_allowed = self._m_bit_string_length**2 - 1
