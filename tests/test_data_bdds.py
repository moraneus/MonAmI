...
class TestDataBdds(unittest.TestCase):
    def test_data_1_all_data_is_the_same_interval_is_extended(self):
    ...
    def test_data_2_all_data_is_the_same_interval_is_extended(self):
        sequence = [["begin", 'Boo', 'Data1'], ["end", 'Boo'], ["begin", 3, 'Data1'], ["end", 3],
    ...
    def test_data_3_all_data_is_not_the_same_interval_is_extended(self):
    ...
    def test_data_4_data_is_not_the_same_interval_and_data_is_extended(self):
        sequence = [["begin", 1, 'Data1'], ["end", 1], ["begin", 2, 'Data2'], ["end", 2],
                    ["begin", 3, "Data1"], ["end", 3]]
        results = {
            'XD': [{'X0': False, 'X1': False, 'X2': False, 'D0': False, 'D1': False, 'D2': False},
                   {'X0': False, 'X1': False, 'X2': True,'D0': False, 'D1': False, 'D2': True},
                   {'X0': False, 'X1': True, 'X2': False, 'D0': False, 'D1': False, 'D2': False}]
        }
    ...
    def test_data_5_all_data_is_not_the_same_interval_and_data_is_extended(self):
        sequence = [["begin", 1, 'Data1'], ["end", 1], ["begin", 2, 'Data2'], ["end", 2],
                    ["begin", 3, "Data3"], ["end", 3]]
        results = {
            'XD': [{'X0': False, 'X1': False, 'X2': False, 'D0': False, 'D1': False, 'D2': False},
