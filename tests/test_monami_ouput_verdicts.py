...
class TestSpecificationSatisfaction():
    ...
    def test_specification_satisfaction_1(self):
        ...
        assert expected_result == current_result[1]

    def test_specification_satisfaction_2(self):
        specification = parse("""!exist A, B . A("Data8") & B("Data2")""")
        expected_result = [True, True, True, True, True, True, True, True, True, True, True, True]
        current_result = monitor(TestSpecificationSatisfaction.sequence, specification,
                                 1, "VIOLATION")
    ...
    def test_specification_satisfaction_3(self):
        specification = parse("""exist A, B . A("Data8") & B("Data2")""")
        expected_result = [False, False, False, False, False, False, False, False, False, False, False, False]
        current_result = monitor(TestSpecificationSatisfaction.sequence, specification,
                                 1, "SATISFACTION")
    ...
    def test_specification_satisfaction_8(self):
        specification = parse("""!exist A, B . A("Data1") & B("Data2") & A < B""")
        expected_result = [True, True, True, False, False, False, False, False, False, False, False, False]
        current_result = monitor(TestSpecificationSatisfaction.sequence, specification,
                                 1, "CONTINUE-SMALL")
    ...
    def test_specification_satisfaction_11(self):
        specification = parse("""exist A, B, C, D, E . A("Data1") & B("Data2") & C("Data3")
         & A < B & A < C & A < D & A < E""")
        expected_result = [False, False, False, False, False, False, False, True, True, True, True, True]
        current_result = monitor(TestSpecificationSatisfaction.sequence, specification,
                                 1, "CONTINUE-SMALL")
    ...
    def test_specification_satisfaction_13(self):
        specification = parse("""!exist A, B, C, D, E . A("Data1") & B("Data2") & C("Data3") & D("Data4") & E("Data6")
         & A < B & A < C & A < D & A < E""")
    ...
    def test_specification_satisfaction_15(self):
        specification = parse("""forall A, B . A("Data1") & B("Data2") -> A < B""")
        expected_result = [True, True, True, True, True, True, True, True, True, True, False, False]
    ...
    def test_specification_satisfaction_17(self):
        specification = parse("""!forall A, B . A("Data1") & B("Data2") -> A < B""")
        expected_result = [False, False, False, False, False, False, False, False, False, False, True, True]
