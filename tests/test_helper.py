...
def update_bdds_without_specification(i_sequence_of_events, i_num_of_variables, i_expansion_length):
    ...
    interval_hash_table = BitstringTable(i_num_of_variables, i_expansion_length)
    data_hash_table = BitstringTable(i_num_of_variables, i_expansion_length)
...
def update_bdds_with_specification(i_sequence_of_events, i_specification, i_num_of_variables):
    ...
    interval_hash_table = BitstringTable(i_num_of_variables)
    data_hash_table = BitstringTable(i_num_of_variables)
    ...
    for event in i_sequence_of_events:
        ...
        result = i_specification.eval(bdd_atl, data_hash_table) == bdd_atl.bdd_manager.true
